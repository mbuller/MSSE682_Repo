...
namespace DAL
{
    ...
    public class DataRepository<T> : IDataRepository<T>, IDataRepository where T : class
    {
        ...
        public DataRepository()
        {
            ...
            _dataContext = new DbContext(ConfigurationManager.ConnectionStrings["bullerMusclesEntities"].ConnectionString);
        ...
        /// <param name="KeyVal">The nullable integer value of the column</param>
        /// <returns></returns>
        public virtual IQueryable<T> GetBySpecificKey(string KeyName, int? KeyVal)
        {
            ...
            var whereExpression = Expression.Lambda<Func<T, bool>>
                ...
                Expression.Equal(
                    ...
                    Expression.Constant(KeyVal, typeof(int?))
                    ),
                new[] { itemParameter }
                );
            try
