...
namespace Service.AuthenticateWebService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="AuthenticateWebServiceSoap", Namespace="http://tempuri.org/")]
    public partial class AuthenticateWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public AuthenticateWebService() {
            this.Url = global::Service.Properties.Settings.Default.Service_AuthenticateWebService_AuthenticateWebService;
        ...
        /// <remarks/>
        public void RegisterAsync(string un, string pw) {
            this.RegisterAsync(un, pw, null);
        }
        
        /// <remarks/>
        public void RegisterAsync(string un, string pw, object userState) {
            if ((this.RegisterOperationCompleted == null)) {
                this.RegisterOperationCompleted = new System.Threading.SendOrPostCallback(this.OnRegisterOperationCompleted);
            }
            this.InvokeAsync("Register", new object[] {
                        un,
                        pw}, this.RegisterOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void LoginAsync(string un, string pw) {
            this.LoginAsync(un, pw, null);
        }
        
        /// <remarks/>
        public void LoginAsync(string un, string pw, object userState) {
            if ((this.LoginOperationCompleted == null)) {
                this.LoginOperationCompleted = new System.Threading.SendOrPostCallback(this.OnLoginOperationCompleted);
            }
            this.InvokeAsync("Login", new object[] {
                        un,
                        pw}, this.LoginOperationCompleted, userState);
        }
